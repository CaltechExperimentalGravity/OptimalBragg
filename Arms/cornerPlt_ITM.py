...
Example usage:
    python cornerPlt_ITM.py aLIGO_ITM_MC.hdf5

The above will make a corner plot from the data in aLIGO_ITM_MC.hdf5
...
plt.savefig('Figures/ITM/ITM_nominal_cornerPlt.pdf')
