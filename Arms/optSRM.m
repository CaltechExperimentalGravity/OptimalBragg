function y=optSRM(x,flag)
x=x(:);
try, flag; catch flag=0; end

lambda_0 = 1064e-9;

no_of_stacks = 3;  % How many pairs of high/low 1/4 wave stacks
...
y=10*(R1(2)-1+0.2)^2 + 1*(R1(3)-0.00)^2 + 0*sum(x(2:2:end)-1/8)^2;
...
title('Calculated SRM HR Reflectivity')
