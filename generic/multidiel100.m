...
function [Gamma1,Z1] = multidiel100(n,L,lambda,theta,pol)
...
theta = theta * pi/180;
                                                              % cos(th(i))
costh = conj(sqrt(conj(1 - (n(1) * sin(theta) ./ n).^2)));    % conj needed when na>n(i) and theta>th_c
                                                              % see Eq.(6.7.19) of text
if strcmp(pol,'te') || strcmp(pol,'TE')
