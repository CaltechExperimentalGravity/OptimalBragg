function y = getCost_aLIGO_ETM_mex(x, params, flag)
% getCost_aLIGO_ETM
...
[Gammap, ~]   = multidiel101_mex(n_IR, L, lambda_IR, aoi, 'tm');
Rp_IR = abs(Gammap).^2;
Tp_IR = 1 - Rp_IR;
...
%Now for green
[Gammap, ~]   = multidiel101_mex(n_green, L_green, lambda_green, aoi_green, 'tm');
