...
ax[0].set_ylabel('Normalized $|E(z)|^2$',fontsize=20,fontweight='extra bold')
ax[1].set_ylabel('Physical layer thickness [nm]',fontsize=20,fontweight='extra bold')
ax[1].set_xlabel('Distance from air interface, $z [\mu \mathrm{m}]$',fontsize=20,fontweight='extra bold')
